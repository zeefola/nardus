        ...
        <div class="row"><!-- row -->
            <div class="col-lg-6">
                ...
                <div class="ttm_single_image-wrapper after-border style2 position-relative ml-20">
                    <img class="img-fluid border-12px-solid white-border" src="/images/who.jpg" title="single-img-five" alt="single-img-five">
                        ...
                        <div class="col-lg-12">
                            <div class="d-md-flex justify-content-md-between align-items-md-center">
                                ...
                                <div class="">
                                    ...
                                    <a href="/contact-us" class="ttm-btn ttm-btn-size-md ttm-btn-style-border ttm-btn-color-white res-767-mt-20"> Contact Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
