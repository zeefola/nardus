        ...
        <div class="row"><!-- row -->
            <div class="col-lg-8 offset-lg-2">
                <div class="text-center">
                    ...
                    <a href="/about-us" class="ttm-btn ttm-btn-size-md ttm-btn-bgcolor-darkgrey mt-20 mr-10">About Nardus</a>
                    <a href="/services" class="ttm-btn ttm-btn-size-md ttm-btn-bgcolor-skincolor mt-20"> Our Services</a>
                </div>
            </div>
        </div><!-- row -->
    </div>
                    ...
                    <div class="row multi-columns-row ttm-boxes-spacing-10px ttm-bgcolor-white mt_140"><!-- row -->
                            ...
                            <div class="featured-imagebox featured-imagebox-portfolio style1">
                                ...
                                <div class="ttm-box-view-overlay"> <!-- ttm-box-view-overlay -->
                                    <div class="ttm-media-link"><!-- ttm-media-link-->
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" href="/images/handwash.jpg" data-rel="prettyPhoto">
                        ...
                        <div class="ttm-box-col-wrapper col-lg-4 col-md-6 col-sm-6">
                            ...
                            <div class="featured-imagebox featured-imagebox-portfolio style1">
                                ...
                                <div class="ttm-box-view-overlay"> <!-- ttm-box-view-overlay -->
                                    <div class="ttm-media-link"><!-- ttm-media-link-->
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" href="/images/diffuser.jpg" data-rel="prettyPhoto">
                                            <i class="ti ti-search"></i>
                                        </a>
                                    </div>
                                    <div class="featured-content"><!-- featured-content-->
                        ...
                        <div class="ttm-box-col-wrapper col-lg-4 col-md-6 col-sm-6">
                            ...
                            <div class="featured-imagebox featured-imagebox-portfolio style1">
                                ...
                                <div class="ttm-box-view-overlay"> <!-- ttm-box-view-overlay -->
                                    <div class="ttm-media-link"><!-- ttm-media-link-->
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" href="/images/oil.jpg" data-rel="prettyPhoto">
                                            <i class="ti ti-search"></i>
                                        </a>
                                    </div>
                                    <div class="featured-content"><!-- featured-content-->
                        ...
                        <div class="ttm-box-col-wrapper col-lg-4 col-md-6 col-sm-6">
                            ...
                            <div class="featured-imagebox featured-imagebox-portfolio style1">
                                ...
                                <div class="ttm-box-view-overlay"> <!-- ttm-box-view-overlay -->
                                    <div class="ttm-media-link"><!-- ttm-media-link-->
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" href="/images/hydrosol.jpg" data-rel="prettyPhoto">
                                            <i class="ti ti-search"></i>
                                        </a>
                                    </div>
                                    <div class="featured-content"><!-- featured-content-->
                        ...
                        <div class="ttm-box-col-wrapper col-lg-4 col-md-6 col-sm-6">
                            ...
                            <div class="featured-imagebox featured-imagebox-portfolio style1">
                                ...
                                <div class="ttm-box-view-overlay"> <!-- ttm-box-view-overlay -->
                                    <div class="ttm-media-link"><!-- ttm-media-link-->
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" href="/images/liquid-soap.jpg" data-rel="prettyPhoto">
                                            <i class="ti ti-search"></i>
                                        </a>
                                    </div>
                                    <div class="featured-content"><!-- featured-content-->
                        ...
                        <div class="ttm-box-col-wrapper col-lg-4 col-md-6 col-sm-6">
                            ...
                            <div class="featured-imagebox featured-imagebox-portfolio style1">
                                ...
                                <div class="ttm-box-view-overlay"> <!-- ttm-box-view-overlay -->
                                    <div class="ttm-media-link"><!-- ttm-media-link-->
                                        <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" href="/images/sanitizer.jpg" data-rel="prettyPhoto">
                                            <i class="ti ti-search"></i>
                                        </a>
                                    </div>
                                    <div class="featured-content"><!-- featured-content-->
