            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                    <div class="widget widget_text  clearfix">
                        ...
                        <div class="">
                            <p>Nardus Company Ltd are a global supplier of Essential Oils into the Flavour, Fragrance
                                and Cosmetic industries. Nardus offer customers an extensive line of essential oils and
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                    <div class="widget contact-widget">
                        ...
                        <ul class="contact-widget-wrapper">
                            ...
                            <li><i class="fa fa-envelope-o"></i><a href="mailto:info@nardus.ng"
                                    target="_blank">{{ config('app.email') }}</a></li>
                        </ul>
                        <div class="social-icons circle social-hover">
                            <ul class="list-inline">
                                <li class="social-facebook"><a class="tooltip-top" target="_blank"
                                        href="{{ config('app.facebook') }}" data-tooltip="Facebook"><i
                                            class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                <li class="social-twitter"><a class="tooltip-top" target="_blank"
                                        href="{{ config('app.twitter') }}" data-tooltip="Twitter"><i
                                            class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                <li class="social-flickr"><a class=" tooltip-top" target="_blank"
                                        href="{{ config('app.instagram') }}" data-tooltip="instagram"><i
