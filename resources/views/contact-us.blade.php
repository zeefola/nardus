                    ...
                    {{ csrf_field() }}
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                <input name="fullname" type="text" class="form-control with-border bg-white" placeholder="Full Name*">
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                          ...
                          <div class="form-group">
                             <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <label for="inputGroupSelect01" class="input-group-text" style="color: rgb(146, 117, 125); font-size: 0.9rem;">Category</label>
                                </div>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                <input name="subject" type="text" placeholder="Subject"  class="form-control with-border bg-white">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
